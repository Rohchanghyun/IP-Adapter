...
ckpt = "fashion_image/checkpoint-30000/model.safetensors"
sd = load_file(ckpt)
image_proj_sd = {}
ip_sd = {}
for k in sd:
...
torch.save({"image_proj": image_proj_sd, "ip_adapter": ip_sd}, "fashion_image/checkpoint-30000/ip_adapter.bin")